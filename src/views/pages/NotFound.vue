<template>
  <div class="main-wrapper">
    <!--404 section start-->
    <section
      class="error-section ptb-120 bg-dark min-vh-100 w-100 d-flex flex-column justify-content-center"
      style="
        background: url('@/assets/img/page-header-bg.svg') no-repeat bottom
          right;
      "
    >
      <div class="container">
